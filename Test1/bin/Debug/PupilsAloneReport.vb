...
Public Class PupilsAloneReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Test1.PupilsAloneReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPupilsAloneReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PupilsAloneReport = New PupilsAloneReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
